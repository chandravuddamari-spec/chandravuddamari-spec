...
timeline
    ...
    section Foundation 2021
        May 2021 : Operations Intern
               : Premier Roadlines
               : 8% delivery optimization
    section Analytical Growth 2022
        Jun 2022 : Data Analyst Intern
               : Younity.in
               : Python analytics foundation
        Aug 2022 : Data Analyst
               : Younity.in
               : 40% reporting efficiency gain
    section Advanced Studies 2024
        Aug 2024 : MS Business Analytics
               : UT Dallas
               : Advanced statistical methods
    section Strategic Leadership 2025
        May 2025 : Research Innovation Analyst
...
![QuickSight](https://img.shields.io/badge/AWS_QuickSight-FF9900?style=for-the-badge&logo=amazon-aws&logoColor=white)
...
![Celonis](https://img.shields.io/badge/Celonis-00C8FF?style=for-the-badge&logo=celonis&logoColor=white)
...
```mermaid
graph TB
    A[Strategic Business Questions] --> B[Data Acquisition]
    B --> C[Statistical Analysis]
    C --> D[Predictive Modeling]
    D --> E[Executive Visualization]
    E --> F[Business Impact]
    
    B --> B1[SQL Multi-Source Integration]
    B --> B2[SAP Enterprise Data]
    B --> B3[API Automation]
    
    C --> C1[Regression Analysis]
    C --> C2[Time Series Forecasting]
    C --> C3[Anomaly Detection]
    C --> C4[A/B Testing]
    
    D --> D1[Feature Engineering]
    D --> D2[Scenario Modeling]
    D --> D3[Risk Assessment]
    
    E --> E1[Power BI Dashboards]
    E --> E2[Executive Narratives]
    E --> E3[KPI Frameworks]
    
    F --> F1[Cost Optimization]
    F --> F2[Revenue Growth]
    F --> F3[Process Efficiency]
